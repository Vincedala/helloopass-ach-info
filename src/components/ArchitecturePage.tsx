...
export function ArchitecturePage() {
  ...
  const models = [
    {
      id: 1,
      title: t('architecture.models.core.title'),
      icon: <Cpu className="text-[#008752]" size={32} />,
      description: t('architecture.models.core.desc'),
      analogy: t('architecture.models.core.analogy'),
      capabilities: [
    ...
    {
      id: 2,
      title: t('architecture.models.compliance.title'),
      icon: <ShieldCheck className="text-[#FFD700]" size={32} />,
      description: t('architecture.models.compliance.desc'),
      analogy: t('architecture.models.compliance.analogy'),
      capabilities: [
    ...
    {
      id: 3,
      title: t('architecture.models.embedded.title'),
      icon: <Box className="text-[#EF3340]" size={32} />,
      description: t('architecture.models.embedded.desc'),
      analogy: t('architecture.models.embedded.analogy'),
      capabilities: [
    ...
    {
      id: 4,
      title: t('architecture.models.trade.title'),
      icon: <ShoppingBag className="text-[#008752]" size={32} />,
      description: t('architecture.models.trade.desc'),
      analogy: t('architecture.models.trade.analogy'),
      capabilities: [
    ...
    {
      id: 5,
      title: t('architecture.models.whiteLabel.title'),
      icon: <Landmark className="text-[#FFD700]" size={32} />,
      description: t('architecture.models.whiteLabel.desc'),
      analogy: t('architecture.models.whiteLabel.analogy'),
      capabilities: [
  ...
  const summaryData = [
    { model: t('architecture.summary.model'), bestFor: t('architecture.summary.bestFor'), get: t('architecture.summary.youGet'), provide: t('architecture.summary.youProvide') },
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <section className="mb-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2 space-y-6">
            ...
            <h2 className="text-4xl font-black">{t('architecture.choosingModel')}</h2>
            ...
            <table className="w-full text-left">
              <thead>
                <tr className="bg-slate-950 border-b border-slate-800">
                  <th className="px-8 py-6 text-[10px] font-black uppercase tracking-widest text-slate-500">{t('architecture.summary.model')}</th>
